...
function PowermailForm($) {
      ...
      if (!regularSubmitOnAjax) {
        $.ajax({
          ...
          success: function(data) {
            ...
            if (html.length) {
              $('*[data-powermail-form="' + formUid + '"]:first').closest('.tx-powermail-slot').html(html);
  ...
  var addProgressbar = function($this) {
    ...
    if ($('.powermail_submit', $this).length) {
      ...
      $this.closest('.tx-powermail-slot').append(getProgressbar());
    }
  };
  ...
  var removeProgressbar = function($this) {
    $this.closest('.tx-powermail-slot').find('.powermail_progressbar').remove();
  };
